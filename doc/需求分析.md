...
4. 电影检索，大概样子如下：
    ...
    ![movieSearch](./img/movieSearch.jpg)
...
comment on column kg_user_info.recently_login is '最近登录';
```
...
create table kg_movies (
    ...
    scenarist varchar2(50),
    staring varchar2(50),
    style varchar2(20),
    type number,
    country_regin varchar2(20),
...
comment on column kg_subscription.name is '订阅名称';
```
...
comment on column kg_comment.object is '评论的对象';
```
